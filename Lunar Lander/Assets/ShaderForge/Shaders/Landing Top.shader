...
////// Lighting:
                ...
                float3 finalColor = (((_Color.rgb*max(0,dot(lightDirection,node_6))*node_22)+(pow(node_22,exp2(_Glosiness))*_Specularity))*_LightColor0.rgb*attenuation);
/// Final Color:
