...
*/
public abstract class DetonatorComponent2 : MonoBehaviour
{
	public bool on = true;
...
public class Detonator2 : MonoBehaviour {
	...
	*/
	...
	public Color color = Detonator2._baseColor;
	public bool explodeOnStart = true;
	public float duration = Detonator2._baseDuration;
	public float detail = 1f; 
